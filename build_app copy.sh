...
# Agregar hidden imports para los módulos de actions antiguos
...
# ── NUEVO: Hidden imports para los módulos dinámicos nuevos ──
...
CMD="$CMD --hidden-import=ollama" # Aseguramos Ollama local también por las dudas
