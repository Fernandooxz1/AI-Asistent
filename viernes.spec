...
binaries = []
hiddenimports = ['actions.system_action', 'actions.browser_action', 'actions.youtube_play_action', 'actions.base_action', 'actions.game_launcher_action', 'actions.keyboard_automation_action', 'actions.conversational_action', 'speech_recognition', 'google.generativeai', 'pyautogui', 'ollama', 'pystray', 'gi', 'gi.repository.Gtk', 'gi.repository.AppIndicator3', 'gi.repository.AyatanaAppIndicator3', 'vosk', 'numpy', 'tts', 'faster_whisper']
